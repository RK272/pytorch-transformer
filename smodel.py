...
class Transformer(nn.Module):
    def __init__(self, encoder:Encoder, decoder:Decoder, src_embed:InputEmbedding, tgt_embed:InputEmbedding, src_pos:PositionalEncoding, tgt_pos:PositionalEncoding, projection:Projectionlayer):
        super().__init__()
        self.encoder = encoder#enoderclass after getting input it layer by layer complete output
    ...
    def encode(self, src, src_mask):
        ...
        return self.encoder(src, src_mask)#passed input to first layer
    def decode(self, encoder_output, src_mask, tgt, tgt_mask):
        tgt = self.tgt_embed(tgt)
        tgt = self.tgt_pos(tgt)
        return self.decoder(tgt, encoder_output, src_mask, tgt_mask)#passed inpu t to decoder
    def project(self, x):
